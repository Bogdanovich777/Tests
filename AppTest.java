...
public class AppTest {
	...
	private static final String REGISTRATION_QUIZFUL = "#user-panel > li:nth-child(3) > a:nth-child(1)";
	...
	private static final String PASSWORD_REPEAT = "//input[@name=\"registrationForm.repassword\"]";
	...
	private static final String BIRTHDAY = "//input[@name=\"personalForm.birthyear\"]";
	...
	public void registrationQuizful() {
		...
		WebElement passwordAgain = driver.findElement(By.xpath(PASSWORD_REPEAT));
	...
	public void editPersonalInfo() {
		...
		secondname.sendKeys("Bogdanovich");
		WebElement dateofbirth = driver.findElement(By.xpath(BIRTHDAY));
		dateofbirth.sendKeys("1987");
		WebElement site = driver.findElement(By.xpath(SITE));
		site.sendKeys("facebook.com");
		WebElement company = driver.findElement(By.xpath(COMPANY));
		company.sendKeys("Melsoft-games");
		...
		aboutMyself.sendKeys("Люблю футбол, парашют и программирование");
